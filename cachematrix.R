...
# i: inversed matrix
# o: result of makeCacheMatrix function, saved as a list
...
# Will caclulate the inverse of the matrix supplied in makeCacheMatrix.
...
# simply recall the result of the previous calculation from memory.
